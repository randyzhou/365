<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-23 11:08:59
         compiled from "/Applications/XAMPP/365/htdocs/phpyun/app/template/admin/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:17495453715fbb27cbbbfa06-63126748%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61efb858f7fc420a4e0806cf36870cf8cbde4bf1' => 
    array (
      0 => '/Applications/XAMPP/365/htdocs/phpyun/app/template/admin/index.htm',
      1 => 1606096911,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17495453715fbb27cbbbfa06-63126748',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fbb27cbc94a50_36662536',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fbb27cbc94a50_36662536')) {function content_5fbb27cbc94a50_36662536($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/XAMPP/365/htdocs/phpyun/app/include/libs/plugins/modifier.date_format.php';
                    ...
                    <div class="admin_new_header_msg" onmouseenter="headerShow('show','admin_new_msg_box')" onmouseleave="headerShow('hide','admin_new_msg_box')">
                        ...
                        <div class="admin_new_msg_box" style="display:none" >
                            ...
                            <ul class="admin_new_msg_list">
								...
								<li class="c_xx3">
									<a href="javascript:_MP(47,'index.php?m=comcert&status=3')">待审核企业认证<span class="admin_new_msg_list_n">( <em class="admin_new_msg_list_n_cur" id="xx3">0</em> )</span></a>
								</li>
								<li class="c_xx4">
			...
			function getMsgnum(){
				$.get("index.php?c=msgNum", function(data) {
					...
					if(datas.msgNum) {
						...
						$('.admin_new_header_msg_new').html(0);
						$('.admin_new_header_msg_new').hide();
					}
