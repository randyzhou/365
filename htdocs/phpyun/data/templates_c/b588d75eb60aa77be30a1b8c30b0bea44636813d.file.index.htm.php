<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-23 11:04:54
         compiled from "/Applications/XAMPP/365/htdocs/phpyun/app/template/default/index/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:2271553775fbb26d6435840-73656210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b588d75eb60aa77be30a1b8c30b0bea44636813d' => 
    array (
      0 => '/Applications/XAMPP/365/htdocs/phpyun/app/template/default/index/index.htm',
      1 => 1606096913,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2271553775fbb26d6435840-73656210',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fbb26d661c723_32652233',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fbb26d661c723_32652233')) {function content_5fbb26d661c723_32652233($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/Applications/XAMPP/365/htdocs/phpyun/app/include/libs/plugins/function.url.php';
if (!is_callable('smarty_function_listurl')) include '/Applications/XAMPP/365/htdocs/phpyun/app/include/libs/plugins/function.listurl.php';
if (!is_callable('smarty_function_webspecial')) include '/Applications/XAMPP/365/htdocs/phpyun/app/include/libs/plugins/function.webspecial.php';
...
?> <?php echo $_smarty_tpl->tpl_vars['adlist_72']->value['html'];?>
 <?php } ?>
		...
		<div class="" style="height:150px;">
			<div class="" style="width:850px; margin:0 auto;position: relative;height: 150px;">
...
global $config;$paramer=array("limit"=>"9","recom"=>"1","type"=>"3","item"=>"'keylist'","nocache"=>"")
;$list=array();
				...
				<div class="first_floor_top">
					...
					<div class="index_help_wanted ">
						<div class="index_title_box">
							<span class="index_titleAll" style="font-size: 14px;">紧急招聘</span>
							<a href="<?php echo smarty_function_listurl(array('type'=>'tp','v'=>1),$_smarty_tpl);?>
" class="first_floor_more" style="right: 0;">查看更多</a>
						</div>
						<div class="" style="width:100%;height:270px; overflow:hidden; float:left; ">
							<div class="index_help_wanted_job ">
								<ul class="">
				...
				if($paramer[noids]==1 && !empty($noids) && in_array($value['id'],$noids)){
					...
					if($value[minsalary]&&$value[maxsalary]){
						if($config['resume_salarytype']==1){
								$urgent_list[$key][job_salary] =$value[minsalary]."-".$value[maxsalary]."元";
						}else{
							if($value[maxsalary]<1000){
								...
								$urgent_list[$key][job_salary] =changeSalary($value[maxsalary])."以下";
							}else{
...
?>
								...
								<li>
						<span class="jp_px <?php if ($_smarty_tpl->tpl_vars['key']->value<3) {?>jp_px<?php echo $_smarty_tpl->tpl_vars['key']->value+1;
...
<span class="jp_new">新</span></a>
										</span>
										<em class="index_help_wanted_job_xz"><?php if ($_smarty_tpl->tpl_vars['urgent_list']->value['job_salary']!='面议') {
}
...
" class="new_gg_titmore">更多</a></div>
	  <ul><?php  $_smarty_tpl->tpl_vars['announcementlist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['announcementlist']->_loop = false;
...
<?php } ?>
			...
			<div class="index_frame_right">
					<div class="new_index_tit" style="border:none;">
					<span class="new_index_tit_list new_index_tit_cur">名企招聘<i class="new_index_tit_line"></i></span>
...
global $db,$db_config,$config;$paramer=array("item"=>"'hotjoblist'","limit"=>"42","nocache"=>"")
;$hotjoblist=array();
...
">
											<img width="90" height="90" border="1" class="on lazy" src='<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
...
"><?php echo $_smarty_tpl->tpl_vars['hotjoblist']->value['username'];?>
			...
			<div class="index_zl_box">
				<div class="new_index_tit" >
					<span class="new_index_tit_list new_index_tit_cur"  data-id="index_new_job">最新职位<i class="new_index_tit_line"></i></span>
					<span class="new_index_tit_list" data-id="index_recommend_job">推荐职位<i class="new_index_tit_line"></i></span>
					<a href="<?php echo smarty_function_url(array('m'=>'job','c'=>'search'),$_smarty_tpl);?>
" class="new_index_tit_more">查看更多</a>
				</div>
		...
		if(is_array($job_list) && !empty($job_list)){
			...
			foreach($job_list as $key=>$value){
				...
				if($paramer[noids]==1 && !empty($noids) && in_array($value['id'],$noids)){
					...
					if($value[minsalary]&&$value[maxsalary]){
						if($config['resume_salarytype']==1){
								$job_list[$key][job_salary] =$value[minsalary]."-".$value[maxsalary]."元";
						}else{
							if($value[maxsalary]<1000){
								if($config['resume_salarytype']==2){
								...
								$job_list[$key][job_salary] =changeSalary($value[maxsalary])."以下";
							}else{
...
"><?php echo $_smarty_tpl->tpl_vars['job_list']->value['name_n'];?>
								...
								<span class="index_newjob_info_xz">
									<?php if ($_smarty_tpl->tpl_vars['job_list']->value['job_salary']!='面议') {
}
...
<i class="index_newjob_info_line">|</i>  <?php echo $_smarty_tpl->tpl_vars['job_list']->value['mun_n'];?>
				...
				<!-- 最新职位 -->
				<div class="index_newjobbox index_zw_item"  id="index_recommend_job" style="display: none;">
					<ul>
						<?php  $_smarty_tpl->tpl_vars['job_list'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['job_list']->_loop = false;
global $db,$db_config,$config;
		$time = time();
...
<i class="index_newjob_info_line">|</i>  <?php echo $_smarty_tpl->tpl_vars['job_list']->value['mun_n'];?>
			...
			<!-- 热招人才 banner 区域-->
			<div class="index_banner fl"style=" margin-top:5px;">
				<div class="index_banner_1250 fl">
...
?>
					<?php echo $_smarty_tpl->tpl_vars['adlist_92']->value['lay_html'];?>
			...
			<div class="index_zl_box">
				...
				<div class="new_index_tit" >
					<span class="new_index_tit_list new_index_tit_cur" data-id="index_new_personnel">最新人才<i class="new_index_tit_line"></i></span>

					<span class="new_index_tit_list " data-id="index_recommend_personnel">推荐人才<i class="new_index_tit_line"></i></span>
					<a href="<?php echo smarty_function_url(array('m'=>'resume','c'=>'search'),$_smarty_tpl);?>
" class="new_index_tit_more">查看更多</a>
				</div>
				
				<!-- 最新人才 -->
				<div id="index_new_personnel" class="index_resume_user_list index_zw_item">
					<ul>
...
$ulist=array();global $db,$db_config,$config;
		...
		$paramer=array("item"=>"'ulist'","post_len"=>"10","limit"=>"24","key"=>"'key'","name"=>"'userlist1'","nocache"=>"")
;
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr[arr];
		$Purl =  $ParamerArr[purl];
...
// 				$ulist[$k]['job_city_three']=$city_name[$v['three_cityid']];
				if($v['minsalary']&&$v['maxsalary']){
                	...
                	if($config['resume_salarytype']==1){
            			...
            			$ulist[$k]["salary_n"] = changeSalary($v['minsalary'])."以上";  
            		}
                }else{
    				$ulist[$k]["salary_n"] = "面议";
    			}
...
if ($_smarty_tpl->tpl_vars['config']->value['sy_user_change']==1) {?>onclick="layer.msg('请先申请企业用户', 2, 8)" <?php } else { ?>onclick="layer.msg('只有企业用户才能查看',
								 2, 8)"<?php }?> <?php } else { ?>href="<?php echo $_smarty_tpl->tpl_vars['ulist']->value['user_url'];?>
...
学历
				...
				<!-- 推荐人才 -->
				<div id="index_recommend_personnel" class="index_resume_user_list index_zw_item none">
					<ul>
...
$ulist_rec=array();global $db,$db_config,$config;
		...
		$paramer=array("item"=>"'ulist_rec'","post_len"=>"10","limit"=>"24","rec_resume"=>"1","key"=>"'key'","name"=>"'userlist2'","nocache"=>"")
;
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr[arr];
		$Purl =  $ParamerArr[purl];
		...
		if(!empty($ulist_rec) && is_array($ulist_rec)){
			...
			foreach($ulist_rec as $k=>$v){
				...
				$week=strtotime(date("Y-m-d",strtotime("-1 week")));
				if($time>$week && $time<$beginYesterday){
					$ulist_rec[$k]['time'] = "一周内";
				}elseif($time>$beginYesterday && $time<$beginToday){
					$ulist_rec[$k]['time'] = "昨天";
				}elseif($time>$beginToday){
					$ulist_rec[$k]['time'] = date("H:i",$v['lastupdate']);
...
// 				$ulist_rec[$k]['job_city_three']=$city_name[$v['three_cityid']];
				if($v['minsalary']&&$v['maxsalary']){
                	...
                	if($config['resume_salarytype']==1){
                		$ulist_rec[$k]["salary_n"] = $v['minsalary']."以上";  
            		}else{
            			$ulist_rec[$k]["salary_n"] = changeSalary($v['minsalary'])."以上";  
            		}
                }else{
...
?>
						<li>
							<div class="index_resume_user">
								<a <?php if ($_smarty_tpl->tpl_vars['config']->value['com_search']==1&&!$_smarty_tpl->tpl_vars['uid']->value) {?> href="javascript:showlogin(2);" <?php } elseif ($_smarty_tpl->tpl_vars['usertype']->value==1) {
if ($_smarty_tpl->tpl_vars['config']->value['sy_user_change']==1) {?>onclick="layer.msg('请先申请企业用户', 2, 8)" <?php } else { ?>onclick="layer.msg('只有企业用户才能查看',
								 2, 8)"<?php }?> <?php } else { ?>href="<?php echo $_smarty_tpl->tpl_vars['ulist_rec']->value['user_url'];?>
" target="_blank" <?php }?> class="index_resume_username">
									<img src='<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/lay-loding.png' lay-src="<?php echo $_smarty_tpl->tpl_vars['ulist_rec']->value['photo'];?>
" width="30" height="30">
									<?php if (in_array($_smarty_tpl->tpl_vars['ulist_rec']->value['id'],$_smarty_tpl->tpl_vars['eid']->value)) {?>
									<?php echo $_smarty_tpl->tpl_vars['ulist_rec']->value['uname'];?>

									<?php } else { ?>
									<?php echo mb_substr($_smarty_tpl->tpl_vars['ulist_rec']->value['username_n'],0,10,"utf-8");?>

									<?php }?>
								</a>
							</div>
							<div class="index_resume_userinfo">
							 <?php echo $_smarty_tpl->tpl_vars['ulist_rec']->value['sex'];?>
<i class="index_resume_userinfo_line">|</i><?php echo $_smarty_tpl->tpl_vars['ulist_rec']->value['age'];?>
...
学历
			...
			<div class="index_zl_box" >
				...
				<div class="new_index_tit" >
					<span class="new_index_tit_list new_index_tit_cur">职场资讯<i class="new_index_tit_line"></i></span>
					<span class="new_index_tit_list" data-no='1'>您关心的职场头条<i class="new_index_tit_line"></i></span>
...
"><?php echo $_smarty_tpl->tpl_vars['alist']->value['title'];?>
			...
			<!-- 友情链接-->
				...
				<div class="new_index_tit" >
					...
					<span class="new_index_tit_list" data-no='1'><?php if ($_smarty_tpl->tpl_vars['config']->value['sy_linksq']==1) {?>
...
" class="new_index_tit_more">查看更多</a>
				...
				<div class="index_link_box fl" style="margin-top: 10px;">
...
global $config;
		...
		if(is_array($link)){$linkList=array();
			...
			{
				if($config["did"]!=0 && $value["did"]!=$config["did"] && $config["did"]!=-1)
				{
					continue;
