					...
					if($config[\'resume_salarytype\']==1){
						...
						if($v[maxsalary]<1000){
							if($config[\'resume_salarytype\']==2){
								'.$name.'[$k]["salary_n"] = "1千以下";    
							}elseif($config[\'resume_salarytype\']==3){
								'.$name.'[$k]["salary_n"] = "1K以下";    
							}elseif($config[\'resume_salarytype\']==4){
								'.$name.'[$k]["salary_n"] = "1k以下";    
							}
						}else{
							'.$name.'[$k]["salary_n"] = changeSalary($v[\'minsalary\'])."-".changeSalary($v[\'maxsalary\']);    
						}
					}
                }else if($v[\'minsalary\']){
                	if($config[\'resume_salarytype\']==1){
            			...
            			'.$name.'[$k]["salary_n"] = changeSalary($v[\'minsalary\'])."以上";  
            		}
                }else{
    				'.$name.'[$k]["salary_n"] = "面议";
    			}
