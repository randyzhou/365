...
class user_member_controller extends adminCommon{
	...
	function Imitate_action(){
	    ...
	    $this -> cookie->add_cookie($member['uid'],$member['username'],$member['salt'],$member['email'],$member['password'],1,1,$member['did']);
	...
	function checkCrm_action(){
	    ...
	    $arr        =   $ResumeM->setUserCrm($gData, $whereData);
