...
*/
$arr_data = array (
	'pay' => array ('alipay'=>'支付宝','tenpay'=>'财富通','bank'=>'银行转帐','alipaydual'=>'支付宝双接口','alipayescow'=>'担保交易','adminpay'=>'管理员充值','balance'=>'余额支付','admincut'=>'管理员扣款','wapalipay'=>'支付宝手机支付','baidu'=>'百度闪付'),
	'source' => array ('1'=>'网页','2'=>'手机','4'=>'微信','6'=>'采集','8'=>'QQ登录','9'=>'微信扫一扫','10'=>'微博','11'=>'PC快速投递','12'=>'WAP快速投递'),
	'rewardstate' => array ( '1'=>array('id'=>'1','name'=>'待查看','state'=>array('0'))
							,'2'=>array('id'=>'2','name'=>'待邀请','state'=>array('1'))
							,'3'=>array('id'=>'3','name'=>'待发Offer','state'=>array('4','5'))
    ...
    'paystate' => array ('<font color=red>支付失败</font>','<font color=green>等待付款</font>','<font color=blsue>支付成功</font>','<font color=#c30ad9>等待确认</font>','<font color=red>交易关闭</font>'),
	//订单类型
	'ordertype' => array(
			1  => '会员充值（购买会员）',
			2  => '积分充值',
	...
	'cache' => array ('1'=>'区域','2'=>'行业','3'=>'职位','4'=>'个人会员分类','5'=>'企业会员分类','6'=>'导航','7'=>'网站缓存','8'=>'SEO设置','9'=>'分站','10'=>'关键字','11'=>'友情链接','12'=>'新闻分类','13'=>'单页面分类','14'=>'广告','15'=>'兼职分类','16'=>'商品分类','17'=>'数据库','18'=>'邮件服务器','19'=>'网站地图','20'=>'问答分类','24'=>'自我介绍分类'),
	'faceurl' => '/config/face/',
	...
	'datacall' => array(
		...
		'lt_job'=>array('猎头职位','order'=>array('id,desc'=>'最新猎头职位','hits,desc'=>'热门猎头职位','lastedit,desc'=>'更新时间'),'field'=>array('jobname'=>'职位名称','url'=>'职位链接','companyname'=>'招聘企业','com_url'=>'企业链接','address'=>'工作地点(江苏-南京)','department'=>'所属部门','hy'=>'所属行业','mun'=>'企业规模','pr'=>'企业性质','report'=>'汇报对象','jobtype'=>'职位类别','constitute'=>'薪资构成','sdate'=>'发布时间','edate'=>'截止日期','job_desc'=>'职位描述','salary'=>'年薪','edu'=>'学历要求','sex'=>'性别要求','language'=>'语言要求','full'=>'是否统招全体制','age'=>'年龄要求','exp'=>'总工资年限','qw_hy'=>'期望行业','eligible'=>'任职资格','desc'=>'企业介绍','name'=>'职位发布人')),
	...
	'modelconfig'=>array('job'=>'找工作','resume'=>'找人才','part'=>'兼职','company'=>'找企业','wap'=>'手机端','article'=>'资讯','announcement'=>'公告','hr'=>'工具箱','zph'=>'招聘会','ask'=>'问答','evaluate'=>'测评','once'=>'店铺招聘','tiny'=>'普工简历','redeem'=>'商城','map'=>'地图','special'=>'专题招聘','login'=>'登录','register'=>'注册','reward'=>'赏金招聘','error'=>'错误提醒'

	),
	'helpconfig'=>array('job_num'=>array('name'=>'发布职位','unit'=>'份'),'breakjob_num'=>array('name'=>'刷新职位','unit'=>'份'),'top_num'=>array('name'=>'置顶职位','unit'=>'天'),'urgent_num'=>array('name'=>'紧急职位','unit'=>'天'),'rec_num'=>array('name'=>'推荐职位','unit'=>'天'),'invite_resume'=>array('name'=>'邀请面试','unit'=>'次'),'down_resume'=>array('name'=>'下载简历','unit'=>'份')),
	'seoconfig'=>array(
		'public'=>array(
			'webname'=>'网站名称',
			'webkeyword'=>'网站关键字',
