...
function check_login(url,img,num){
  ...
  var referurl=$("#referurl").val();
	...
	$.post(url,{act_login:act_login,num:num,referurl:referurl,username:username,password:password,path:path,loginname:loginname,authcode:authcode,geetest_challenge:geetest_challenge,geetest_validate:geetest_validate,geetest_seccode:geetest_seccode,dx_token:dx_token},function(data){ 
