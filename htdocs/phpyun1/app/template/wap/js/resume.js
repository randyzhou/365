...
function app_height_status(id) {
	$("#wname .sq_gjresume_bth").html("<a class=\"sq_gjresume_bth_a\" href=\"javascript:void(0);\" onclick=\"layer_del('','index.php?c=resumeset&height=" + id + "');\">申请优质简历</a>");
