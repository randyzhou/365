	...
	$("#click_invite").click(function(){
		...
		$.post(wapurl + '/index.php?c=ajax&a=ajax_day_action_check', {'type' : 'interview'}, function(data){
			...
			if(data.status == -1){
				...
				$.post(wapurl+"/index.php?c=ajax&a=sava_ajaxresume", {uid:uid,content:content,username:username,jobname:jobname,address:address,linkman:linkman,linktel:linktel,intertime:intertime,jobid:jobid}, function(data){
