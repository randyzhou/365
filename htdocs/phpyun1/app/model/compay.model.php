...
class compay_model extends model{
    ...
    function buyVip($data){
        ...
        if($data['ratingid']){
            ...
            $rating     =   $this -> select_once('company_rating',array('id' => $ratingId));
            ...
            if($this->config['com_integral_online'] == 1){
                ...
                $dkjf   =   $data['dkjf'] ? intval($data['dkjf']) : '';
                
            }elseif ($this->config['com_integral_online'] == 3){
                
                $jifen  =   !empty($data['price_int']) ? intval($data['price_int']) : '';
            }
            ...
            if (!empty($jifen)) {
                ...
                $vip_integral   =   $price * $this->config['integral_proportion'];
    ...
    function buyPackOrder($data){
        ...
        if($data['tcid']){
            ...
            if($this->config['com_integral_online'] == 1){
                ...
                $jifen  =   $data['price_int'] ? intval($data['price_int']) : '';
            }
            ...
            $rating     =   $this -> select_once('company_rating',array('id' => $statis['rating']), '`service_discount`');
            ...
            if ($jifen) {
                ...
                $pack_integral  =   $price * $this->config['integral_proportion'];
                $integral_min   =   $this -> config['integral_min_recharge'];
        ...
        if($data['jobautoids'] && ($data['days'] || $data['xdays'])){
            ...
            if($autodays > 0 && $jobautoids){
                ...
                if(empty($jobs)){
                    ...
                    $jobnum =   $this->select_num('company_job', array('uid' => $uid, 'id' => array('in',$jobautoids)));
                    ...
                    if ($jifen) {
                        ...
                        $auto_integral      =   $price * $this->config['integral_proportion'];
                        $integral_min       =   $this -> config['integral_min_recharge'];
            ...
            if($xsdays > 0 && $jobid){
                ...
                if(empty($job)){
                    ...
                    if ($jifen) {
                        ...
                        $jobzd_integral     =   $price * $this->config['integral_proportion'];
                        $integral_min       =   $this -> config['integral_min_recharge'];
            ...
            if($recdays > 0 && $jobid){
                ...
                if(empty($job)){
                    ...
                    if ($jifen) {
                        ...
                        $jobrec_integral    =   $price * $this->config['integral_proportion'];
                        $integral_min       =   $this -> config['integral_min_recharge'];
            ...
            if($recdays > 0 && $jobid){
                ...
                if(empty($job)){
                    ...
                    if ($jifen) {
                        ...
                        $recpart_integral=   $price * $this->config['integral_proportion'];
                        $integral_min       =   $this -> config['integral_min_recharge'];
            ...
            if($udays > 0 && $jobid){
                ...
                if(empty($job)){
                    ...
                    if ($jifen) {
                        ...
                        $joburgent_integral     =   $price * $this->config['integral_proportion'];
                        $integral_min           =   $this -> config['integral_min_recharge'];
        ...
        if ($data['sxjobid']) {
            ...
            if ($jobid) {
                ...
                if (empty($jobs)) {
                    ...
                    $jobnum =   $this->select_num('company_job', array('uid' => $uid, 'id' => array('in', $jobid)));
                    ...
                    if ($jifen) {
                        ...
                        $sxjob_integral         =   $price * $this->config['integral_proportion'];
                        $integral_min           =   $this -> config['integral_min_recharge'];
        ...
        if ($data['sxpartid']) {
            ...
            if ($jobid) {
                ...
                if (empty($parts)) {
                    ...
                    $partnum    =   $this->select_num('partjob', array('uid' => $uid, 'id' => array('in', $jobid)));

                    if ($breakpart_num) {
                        $partnum    =   $partnum - $breakpart_num;
                    }

                    $price  =   $this->config['integral_jobefresh'] * $partnum;
                    ...
                    if ($jifen) {
                        ...
                        $sxpart_integral        =   $price * $this->config['integral_proportion'];
                        $integral_min           =   $this -> config['integral_min_recharge'];
        ...
        if($data['eid']){
            ...
            if(empty($resume)){
                ...
                if ($jifen) {
                    ...
                    $resume_integral    =   $price * $this->config['integral_proportion'];
                    $integral_min       =   $this -> config['integral_min_recharge'];
    ...
    function buyInviteResume($data){
        ...
        if ($jifen) {
            ...
            $invite_integral    =   $price * $this->config['integral_proportion'];
            $integral_min       =   $this -> config['integral_min_recharge'];
    ...
    function buyZph($data = array()){
        ...
        if($data['zid'] && $data['bid']){
            ...
            if($this->config['com_integral_online'] == 1){
                ...
                $dkjf   =   !empty($data['dkjf']) ? intval($data['dkjf']) : '';
            ...
            if(empty($zph) || empty($space)){
                ...
                if ($jifen) {
                    ...
                    $zph_integral  =  $price * $this->config['integral_proportion'];
                    $integral_min  =  $this -> config['integral_min_recharge'];
                ...
                if ($price < 0.01){
                    ...
                    if($jifen){
                        $orderData['order_info']  =  serialize(array('uid' => $uid , 'com_name' => $com['name'] , 'zid' => $zid ,'bid'=> $bid , 'sid' => $sid['keyid'] , 'cid' => $space['keyid'], 'zph_integral' => $zph_integral));
                    }else{
                        $orderData['order_info']  =  serialize(array('uid' => $uid , 'com_name' => $com['name'] , 'zid' => $zid ,'bid'=> $bid , 'sid' => $sid['keyid'] , 'cid' => $space['keyid']));
                    }
