...
class comtc_model extends model
{
                    ...
                    if ($statis['rating_type'] == '1') { 
                        ...
                        if ($statis['breakjob_num'] >= $jobnum) {
                            ...
                            if ($nid) {
                                ...
                                if ($jobnum == 1) {
                                    ...
                                    $this->addMemberLog($uid, $usertype, "刷新职位《".$jobs[0]['name']."》", 1, 4); 
                                } else {
                                
                                    $this->addMemberLog($uid, $usertype, "批量刷新职位", 1, 4); 
                                }
                                $return['status']   =   1;
                                $return['msg']      =   '职位刷新成功';
                            ...
                            if (!empty($spid)) {
                                ...
                                if ($online != 4) {
                                    ...
                                    if($online == 3){
                                        ...
                                        $return['jifen']    =   $num * $this->config['integral_jobefresh'] * $pro;  
                                        $return['integral'] =   intval($statis['integral']);
                                        $return['pro']      =   $pro;
                                    }else{
                                        
                                        $return['price']    =   $num * $this->config['integral_jobefresh'];         
                                        $return['integral'] =   intval($statis['integral']);
                                    }
                        ...
                        if ($nid) {
                            ...
                            if ($jobnum == 1) {
                                ...
                                $this->addMemberLog($uid, $usertype, "刷新职位《".$jobs[0]['name']."》", 1, 4, 1); 
                            } else {
                                
                                $this->addMemberLog($uid, $usertype, "批量刷新职位", 1, 4, $jobnum); 
                            }
    ...
    function refresh_part($data)
    {
        ...
        if ($data['partid']) {
            ...
            $parts  =   $this->select_all('partjob', array('id' => array('in', $partid)), '`id`,`name`');
                    ...
                    if ($statis['rating_type'] == '1') { 
                        ...
                        if ($statis['breakjob_num'] >= $pnum) {
                            ...
                            if ($nid) {
                                ...
                                if ($pnum == 1) {
                                    ...
                                    $this->addMemberLog($uid, $usertype, "刷新兼职《".$parts[0]['name']."》", 9, 4); 
                                } else {
                                    
                                    $this->addMemberLog($uid, $usertype, "批量刷新兼职", 9, 4); 
                                }
                        ...
                        if ($nid) {
                            ...
                            if ($pnum == 1) {
                                ...
                                $this->addMemberLog($uid, $usertype, "刷新兼职《".$parts[0]['name']."》", 9, 4, 1); 
                            } else {
                               
                                
                                $this->addMemberLog($uid, $usertype, "批量刷新兼职", 9, 4, $pnum); 
                            }
