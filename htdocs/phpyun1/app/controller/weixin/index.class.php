					...
					if($postObj->EventKey){
						...
						if(!$result){
							if(isset($utype) && $utype=='amminwxbind'){
								$centerStr = "<Content><![CDATA[该账号不存在！]]></Content>";
							}else{
								...
								$centerStr = "<Content><![CDATA[".$loginStr."]]></Content>";
							}
							
						}else{
							if(isset($utype) && $utype=='amminwxbind'){
								$centerStr = "<Content><![CDATA[扫码绑定成功！]]></Content>";
							}elseif(isset($utype) && $utype=='binded'){
								$centerStr = "<Content><![CDATA[该微信已绑定其它账号，请先解除绑定！]]></Content>";
							}else{
