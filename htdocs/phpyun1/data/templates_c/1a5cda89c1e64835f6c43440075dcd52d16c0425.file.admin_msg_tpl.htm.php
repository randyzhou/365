<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-07 02:57:55
         compiled from "D:\rcw\uploads\app\template\admin\admin_msg_tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:11865695615fa59cb380d108-19618587%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a5cda89c1e64835f6c43440075dcd52d16c0425' => 
    array (
      0 => 'D:\\rcw\\uploads\\app\\template\\admin\\admin_msg_tpl.htm',
      1 => 1578558798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11865695615fa59cb380d108-19618587',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fa59cb3856bd9_29972617',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fa59cb3856bd9_29972617')) {function content_5fa59cb3856bd9_29972617($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<div class="tag_box">
    ...
    <table width="100%" class="table_form">
      <tr class="admin_table_trbg">
       <th width="160" bgcolor="#f0f6fb" colspan="2"><span class="admin_bold">公共设置</span></th>
    </tr>
	        
              <tr>
            <th width="160">申请切换身份审核通知：</th>
            <td>
            <div class="layui-form-item">
              <div class="layui-input-block">
                 <div class="layui-input-inline">
                   <input type="radio" name="sy_msg_userchange" value="1" id="sy_msg_userchange_0" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_msg_userchange']=="1") {?>checked<?php }?> title="通知">
                   <input type="radio" name="sy_msg_userchange" value="2" id="sy_msg_userchange_1" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_msg_userchange']=="2") {?>checked<?php }?> title="不通知">
                 </div>
                 <div class="layui-form-mid layui-word-aux"><a href="?m=msgconfig&c=settpl&name=msguserchange" style="color:blue;">设置模板</a> </div>
               </div>
            </div>
             </td>
        </tr>
		...
		<tr>
            ...
            <div class="layui-form-item">
              <div class="layui-input-block">
                 <div class="layui-input-inline">
                   <input type="radio" name="sy_msg_logouted" value="1" id="sy_msg_logouted_0" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_msg_logouted']=="1") {?>checked<?php }?> title="通知">
                   <input type="radio" name="sy_msg_logouted" value="2" id="sy_msg_logouted_1" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_msg_logouted']=="2") {?>checked<?php }?> title="不通知">
                 </div>
                 <div class="layui-form-mid layui-word-aux"><a href="?m=msgconfig&c=settpl&name=msglogouted" style="color:blue;">设置模板</a> </div>
               </div>
            </div>
             </td>
        </tr>
		<tr>
			<th width="160" bgcolor="#f0f6fb" colspan="2"><span class="admin_bold">个人短信设置</span></th>
		</tr>
         <tr>
		...
		<tr>
			<th width="160" bgcolor="#f0f6fb" colspan="2"><span class="admin_bold">企业短信设置</span></th>
		</tr>
         <tr>
...
$(function(){
	$("#msgconfig").click(function(){
		...
		$.post("index.php?m=msgconfig&c=save",{
			...
			sy_msg_userchange : $("input[name=sy_msg_userchange]:checked").val(),
			sy_msg_notuserchange : $("input[name=sy_msg_notuserchange]:checked").val(),
			...
			sy_msg_subjectshtg : $("input[name=sy_msg_subjectshtg]:checked").val(),
			sy_msg_subjectshwtg : $("input[name=sy_msg_subjectshwtg]:checked").val(),
			...
			sy_msg_logouted: $("input[name=sy_msg_logouted]:checked").val(),
