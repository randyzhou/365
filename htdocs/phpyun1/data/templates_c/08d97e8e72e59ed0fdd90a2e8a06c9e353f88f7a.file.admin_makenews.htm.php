<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-10-31 16:35:01
         compiled from "D:\rcw\uploads\app\template\admin\admin_makenews.htm" */ ?>
<?php /*%%SmartyHeaderCode:4428436175f9d21b5360186-88873701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '08d97e8e72e59ed0fdd90a2e8a06c9e353f88f7a' => 
    array (
      0 => 'D:\\rcw\\uploads\\app\\template\\admin\\admin_makenews.htm',
      1 => 1576479798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4428436175f9d21b5360186-88873701',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9d21b5378e62_77308493',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9d21b5378e62_77308493')) {function content_5f9d21b5378e62_77308493($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
function makearchive(stime,etime,group,startid,endid,limit,type,value,msg){
	...
	if(type!="ok"){
		...
		$.post(
			...
			{action:"makearchive",group:group,startid:startid,endid:endid,limit:limit,type:type,value:value,pytoken:pytoken,stime:stime,etime:etime},
			function(data){
				parent.layer.close(ii);
				var data=eval('('+data+')');
