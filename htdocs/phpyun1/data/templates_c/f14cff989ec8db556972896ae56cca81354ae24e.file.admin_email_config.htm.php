<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-07 02:52:41
         compiled from "D:\rcw\uploads\app\template\admin\admin_email_config.htm" */ ?>
<?php /*%%SmartyHeaderCode:20900359755fa59b790f3d21-70939907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f14cff989ec8db556972896ae56cca81354ae24e' => 
    array (
      0 => 'D:\\rcw\\uploads\\app\\template\\admin\\admin_email_config.htm',
      1 => 1576479798,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20900359755fa59b790f3d21-70939907',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fa59b79115569_85568982',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fa59b79115569_85568982')) {function content_5fa59b79115569_85568982($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
						...
						<tr class="email admin_table_trbg">
						 <th width="200">&nbsp;</th>
							<td align="left">
								...
								<input class="layui-btn layui-btn-normal" type="button" value="新增" onclick="javascript:$('#emailtable').append($('#appendconfig').html());" />
							</td>
						</tr>
					</table>
					...
					<div id="aliyunemail" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_online']=="1") {?>style="display:none;"<?php }?>>
						<table width="100%" class="table_form">
							<tr class="email admin_table_trbg">
								...
								<td><input class="input-text tips_class" type="text" name="accesskey" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['accesskey'];?>
" size="30" maxlength="255"/><span class="admin_web_tip">如：j8Blubzc8v4BwQte</span></td>
							</tr>
							<tr class="email">
								<th width="200">Access Key Secret：</th>
								<td><input class="input-text tips_class" type="text" name="accesssecret" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['accesssecret'];?>
" size="30" maxlength="255"/><span class="admin_web_tip">如：phpyun@qq.com</span></td>
							</tr>
							<tr class="email">
								<th width="200">发信地址：</th>
								<td><input class="input-text tips_class" type="text" name="ali_email"  value="<?php echo $_smarty_tpl->tpl_vars['config']->value['ali_email'];?>
" size="30" maxlength="255"/></td>
							</tr>
							<tr class="email admin_table_trbg">
								<th width="200">标签: </th>
								<td><input class="input-text tips_class" type="text" name="ali_tag" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['ali_tag'];?>
" size="30" maxlength="255"/></td>
							</tr>
							<tr>
								<th width="200">发件人昵称: </th>
								<td><input class="input-text tips_class" type="text" name="ali_name" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['ali_name'];?>
" size="30" maxlength="255"/></td>
							</tr>
						</table>
					</div>
					...
					<table width="100%" class="table_form aliyunemail" <?php if ($_smarty_tpl->tpl_vars['config']->value['sy_email_online']=="1") {?>style="display:none;"<?php }?>>
						<tr class="email admin_table_trbg">
							<th width="200">&nbsp;</th>
							<td align="left">
								<input class="layui-btn layui-btn-normal"  type="submit" name="aliconfig" value="保存" />&nbsp;&nbsp;
								<input class="layui-btn layui-btn-normal testconfig" data-id="aliyun" type="button" value="测试" />
							</td>
						</tr>
					</table>
