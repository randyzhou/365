<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-10-31 16:56:50
         compiled from "D:\rcw\uploads\app\template\admin\admin_comclass.htm" */ ?>
<?php /*%%SmartyHeaderCode:1215540935f9d26d2572632-76978695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d427fc225f8f8d53cf305080187413249902e93' => 
    array (
      0 => 'D:\\rcw\\uploads\\app\\template\\admin\\admin_comclass.htm',
      1 => 1576479745,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1215540935f9d26d2572632-76978695',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f9d26d25ac258_17954910',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f9d26d25ac258_17954910')) {function content_5f9d26d25ac258_17954910($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<a href="javascript:;" class="admin_new_tip_open" style="display:none;"></a>
    ...
    <div class="admin_new_tip_list_cont">
      <div class="admin_new_tip_list">该页面展示了网站企业会员分类信息，可对企业会员分类编辑修改操作。</div>
    </div>
  </div>
  <div class="admin_new_search_box">
  <a   href="javascript:void(0)" onClick="add_class('企业会员分类','450','360','#wname','index.php?m=comclass&c=save')"  class="admin_new_cz_tj" style="margin-left:0px;">+ 添加类别</a>
  </div>
  <div class="clear"></div>
...
" size="20" disabled/></td>    
		<td class="ud">
        <A href="index.php?m=comclass&c=up&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" class="admin_new_c_bth">管理</A>
        <A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
');"/></td>
        ...
        <td class="ud"></td>
		<td class="ud" width="180"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['class1']->value['id'];?>
');" class="admin_new_c_bth admin_new_c_bth_sc">删除</A></td>
	</tr>
	<?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
');"/>
		...
		<td class="ud"><A href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=comclass&c=del&delid=<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
');" class="admin_new_c_bth admin_new_c_bth_sc">删除</A></td>
	</tr>
	<?php } ?>
	<?php }?>
