...
let homeAntdDistrict =[];
let workAntdDistrict =[];
Object.keys(districtData).forEach((index)=>{
  ...
  homeAntdDistrict.push(itemLevel1)
});
Object.keys(districtData).forEach((index)=>{
  let itemLevel1 ={};
  let itemLevel2 ={};
  ...
  workAntdDistrict.push(itemLevel1)
});
...
//    this.handleChange = this.handleChange.bind(this);
    ...
    this.uploadPicCancel = this.uploadPicCancel.bind(this);
  ...
  handleDateChange(value){
    let userbirthday = `${value.getFullYear()}-${value.getMonth()}-${value.getDate()}`;
    var user = this.state.user;
  ...
  uploadPicCancel=()=>{this.setState({imagefile:null});}
  selectPic=()=>{this.refs["userpic"].click();}
  handleUploadChange=(event)=>{
    ...
    reader.onload = function() {
      ...
      var img = new Image();
      img.src = result;
      if (result.length <= 1024* 10 || result.length >= 1024*500) {
        img = null;
        alert("图片小于10k或大于500k")
        return;
      }
      ...
      function callback() {
        that.setState({img,imagefile:result,fileType:file.type});
        img = null;
      }
    };
  }
  ...
  uploadPic=()=>{
    let imagefile = compress(this.state.img);
    let url = photoApi + "/topuser/uploadpic?id="+this.state.user.userid;
    upload(imagefile,this.state.fileType,url,function(res){
      resultAlert(res);
      if(res.status == 200){
        let avatar = res.avatar;
        this.updateSubmit("avatar",avatar);
        this.setState({userpic:this.state.imagefile,imagefile:null});
      }
    }.bind(this));
  }
  ...
  render(){
    ...
    let homeAreaValue = [this.state.user.homeprovince,this.state.user.homecity];
    let workAreaValue = [this.state.user.workprovince,this.state.user.workcity,this.state.user.workdistrict];
    ...
    return (
      <form style={{width:"100%",height:"100%",overflowY:"auto"}}>
        <table id="imagefileTable" style={{display:this.state.imagefile?"table":"none",position:"fixed",zIndex:"1000000000",top:"0px",left:"0px",width:"100%",height:"100%",backgroundColor:"black"}}>
        <tbody>
        <tr>
          <td style={{color:"#111",height:"40px",textAlign:"center",verticalAlign:"middle"}}>
            <table style={{width:"100%",position:"relative",marginTop:"10px"}}><tbody><tr>
              <td></td>
              <td style={{color:"#111",width:"100px",height:"40px",textAlign:"center",verticalAlign:"middle"}}>
                  <span className="btn-info" onTouchEnd={this.uploadPic}>点击上传</span>
              </td>
              <td style={{color:"#111",width:"100px",height:"40px",textAlign:"center",verticalAlign:"middle"}}>
                  <span className="btn-info" onTouchEnd={this.uploadPicCancel}>取消上传</span>
              </td>
              <td></td>
            </tr></tbody></table>
          </td>
        </tr>
        <tr><td style={{verticalAlign:"top"}}><img id="imagefile" src={this.state.imagefile} style={{width:this.state.phoneWidth}}/></td></tr>
        </tbody>
        </table>
          ...
          <tr><td>
              ...
              <tr><td style={{textAlign:"center"}}>
                <table style={{width:"100%",position:"relative"}}><tbody><tr>
                  <td style={{backgroundColor:"#eee",width:"80px"}}>
                    <span style={{padding:"3px",borderRadius:"3px"}} onTouchEnd={touchEnd.bind(this,"#/me/admin")}>《</span>
                  </td>
                  <td style={{backgroundColor:"#eee",textAlign:"center"}}><span onTouchEnd={touchEnd.bind(this,"#/users/detail/"+this.state.user.userid)}>{this.state.user.username}</span></td>
                  <td style={{backgroundColor:"#eee",width:"80px",height:"40px",textAlign:"right",verticalAlign:"middle"}}>
                      <span style={{padding:"3px",borderRadius:"3px",marginRight:"10px",color:"green"}} onTouchEnd={this.selectPic}>个人照片</span>
                      <input id="userpic" ref="userpic" type="file" accept="image/*" style={{display:"none"}} onChange={this.handleUploadChange}/>
                  </td>
                </tr></tbody></table>
                <img id="userImg" src={this.state.userpic?this.state.userpic:photoUrl+"/topuserphotos/"+photoname+".jpg"} style={{width:this.state.phoneWidth}}/>
              </td></tr>
            </tbody></table>
            ...
            <List style={{backgroundColor:'white'}} className="picker-list">
                  <Picker
                    ...
                    cascade={false}
                    extra="请选择(可选)"
                    value={[parseInt(this.state.user.usersex)]}
                    onChange={this.handleSelectChange.bind(this,"usersex")}
                  >
                    <List.Item arrow="horizontal">性别</List.Item>
                  </Picker>
            </List>
            <List className="date-picker-list" renderFooter={() => getFieldError('dp') && getFieldError('dp').join(',')}>
              <DatePicker
                mode="date"
                title="选择日期"
                extra="Optional"
            ...
            <List style={{backgroundColor:'white'}} className="picker-list">
                  <Picker
                    ...
                    cascade={false}
                    extra="请选择(可选)"
                    value={[this.state.user.shengxiao]}
            ...
            <List style={{backgroundColor:'white'}} className="picker-list">
                  <Picker
                    ...
                    cascade={false}
                    extra="请选择(可选)"
                    value={[this.state.user.constellation]}
            ...
            <List style={{backgroundColor:'white'}} className="picker-list">
                  <Picker
                    ...
                    cascade={false}
                    extra="请选择(可选)"
                    value={[this.state.user.bloodtype]}
            ...
            <List style={{backgroundColor:'white'}} className="picker-list">
              ...
              >
                  <List.Item arrow="horizontal">工作地</List.Item>
              </Picker>
            </List>  
            ...
            <List style={{backgroundColor:'white'}}>
              <InputItem type="text" style={{textAlign:"right",color:"#888"}} placeholder="道路名称" error={this.state.hasError} onErrorClick={this.onErrorClick} onChange={this.handleChange.bind(this,"workstreet")} value={this.state.user.workstreet||""}>道路名称</InputItem>
            </List>
            <List style={{backgroundColor:'white'}}>
              <InputItem type="text" style={{textAlign:"right",color:"#888"}} placeholder="建筑名称" error={this.state.hasError} onErrorClick={this.onErrorClick} onChange={this.handleChange.bind(this,"workbuilding")} value={this.state.user.workbuilding||""}>建筑名称</InputItem>
            </List>                    
            <List style={{backgroundColor:'white'}} className="picker-list">
                  <Picker
                    data={[[
