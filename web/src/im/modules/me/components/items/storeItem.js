export default class Store extends React.Component{
  ...
  showGroupAdmin(id,groupname,groupuserid,groupusername){
    this.props.showGroupAdmin(id,groupname,groupuserid,groupusername);
  }
        ...
        <tbody>
        	<tr style={Style.divRow}>
        		<td className="content" style={{border:"0px red solid"}}>
                  ...
                  <td style={{width:"80px",verticalAlign:"middle",textAlign:"right",paddingRight:"10px",color:"#555555"}} onTouchEnd={this.showGroupAdmin.bind(this,$group.id,$group.group_name,$group.group_userid,$group.group_username)}>{$group.group_username}</td>
                  </tr></tbody></table>
        				</div>
        			</div>
        		</td>
