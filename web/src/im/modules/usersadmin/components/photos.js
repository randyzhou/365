...
export default class Adminphotos extends React.Component{
  ...
  handleUploadSubmit=()=>{
    ...
    var $this = this;
    let url = Config.api + "photo/create?typeid=3";
    fetchApi({
      url,
      method: "POST",
  ...
  sendPost=()=>{
    ...
    let url = Config.api + "photo/update?typeid=3"+queryStr;
    fetchApi({
      url,
      method: "POST",
  ...
  deletePhoto=(id)=>{
    var url = Config.api + "photo/delete?typeid=3";
    fetchApi({
      url,
      method: 'POST',
      body: {id:id}
  ...
  render(){
    ...
    return (
      <div ref="main" style={{width:"100%",height:"100%"}}>
        <table style={{width:"100%",height:"100%"}}><tbody>
          ...
          <tr><td style={{textAlign:"right",paddingRight:"5px",backgroundColor:"#eee",height:"40px",lineHeight:"40px"}}>
            <Upload 
              ...
              title="上传图片"
              uploadurl={photoApi + "/user/uploadpic"}
          ...
          <tr><td style={{overflowY:"scroll",verticalAlign:"top"}}>  
            <Listall 
              apiurl={Config.api+'photo/listadmin?typeid=3'} 
        ...
        <tr><td style={{verticalAlign:"top"}}><img id="imagefile" src={photoUrl + "/userphotos/"+this.state.avatar+".jpg"} style={{width:'100%'}}/></td></tr>
        <tr><td></td></tr>
        </tbody></table>
        ...
        <div style={{display:this.state.showPostDiv,position:"fixed",top:"0px",zIndex:"1000000",textAlign:"center",width:"100%",height:"100%",backgroundColor:"white"}}>
          ...
          <table style={{width:"100%"}}><tbody>
            <tr><td style={{textAlign:"center"}}>
              <img id="userImg" src={photoUrl+"/userphotos/"+this.state.avatar_up+".jpg"} style={{width:'100%'}}/>
            </td></tr>
          </tbody></table>
        </div>          
