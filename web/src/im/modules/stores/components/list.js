...
export default class List extends React.Component{
  ...
  render(){
    ...
    const row = (rowData, sectionID, rowID) => {
      ...
      return (
        <ListItem key={rowID} index={rowID} item={rowData} phoneWidth={this.state.phoneWidth} showDetailDiv={this.showDetailDiv}/>
      );
    };
                ...
                <tr>
                  ...
                  <td style={{textAlign:"left",verticalAlign:"top"}}>
                    <div style={{color:"333",overflowY:"auto",width:"90%",height:"99%",margin:"0 auto",textAlign:"center"}}>
                      ...
                      <div style={{textAlign:"center", color:"firebrick", fontSize:"14px", marginTop: "20px"}}><span onTouchEnd={touchEnd.bind(this,"#/stores/main/"+selectedStore.id)} style={{marginLeft:"10px",padding:"7px",color:"white",backgroundColor:"crimson",borderRadius:"5px",fontSize:"16px",fontFamily:"sans_serif"}}>进入店铺主页</span></div>
