export default class ListItem extends React.Component{
  ...
  showDetailDiv=()=>{
    backurl_user = "#/users/main/"+this.props.item.userid;
      ...
      <table style={{ width:"100%",height:"100%"}}><tbody><tr>
        ...
        <td style={{verticalAlign:"top",padding:"5px",lineHeight:"15px"}}>
          <table><tbody>
            <tr>
              <td>
                <div style={{dispay:"block", whiteSpace:"nowrap", fontSize:"14px", fontWeight:"bold"}}>
                  ...
                  <span style={{color:"green"}}>{$store.phone}</span>
                </div>
              </td>
            ...
            <tr>
              <td>
                <div style={{dispay:"block", whiteSpace:"nowrap", textOverflow:"ellipsis", overflow:"hidden", width:"180px",textAlign:"left",fontSize:"12px",color:"999"}} onTouchEnd={this.showDetailDiv}>{$store.city}{$store.district}{$store.town}{$store.street}{$store.building}</div>
              </td>
              <td>
            ...
            <tr><td colSpan="2" style={{dispay:"block", whiteSpace:"nowrap", textOverflow:"ellipsis", overflow:"hidden", width:"200px",maxWidth:"200px"}}>
              <span style={{color:"darkred",fontWeight:"bold"}} onTouchEnd={this.showDetailDiv}>{$store.promote_title}</span>
            </td></tr>
          </tbody></table>
        </td></tr>
      </tbody></table>  
