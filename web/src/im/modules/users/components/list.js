import UserListItem from "./items/userList";
export default class Userlist extends React.Component {
  ...
  touchMove = (event)=>{
    ...
    slides.moveX = moveX;
    if(moveX < -100) location.href = '#/news';
    if(moveX > 100) location.href = '#/stores';
    if(moveX > 100){
  ...
  render(){
    ...
    return (
      <div style={{width:"100%",height:"100%"}} onTouchStart={this.touchStart} onTouchMove={this.touchMove}>
        ...
        <tr style={{height:"43px"}}><td>  
          ...
          <tr>
            <td style={{width:"80px",textAlign:"center"}}>
              <span style={{marginRight:"5px",display:this.state.searchDivShow=='none'?'none':''}} onTouchEnd={this.showSearchDiv}>收起  </span>
              <span style={{marginRight:"5px",display:this.state.searchDivShow=='none'?'':'none'}} onTouchEnd={this.showAll}>所有  </span>
            </td>          
            ...
            <td style={{width:"80px",textAlign:"center"}} onTouchEnd={this.handleLocationSearch}>附近</td>
          </tr>
          </tbody></table>
        </td></tr>
        <tr><td style={{overflowY:"scroll",verticalAlign:"top"}}>  
          <Listall 
            apiurl={Config.api+'user/list'} 
            hashurl="#/users"
            backurl={"#/users"} 
            ...
            <table style={{width:"100%",height:"100%",backgroundColor:"white",margin:"0 auto"}}><tbody>
              <tr><td style={{borderBottom:"1px #ccc solid",padding:"5px",textAlign:"center",backgroundColor:"darkseagreen",height:"40px"}}>
                  ...
                  <tr>
                    ...
                    <td style={{width:"60px",color:"white",textAlign:"center"}} onClick={this.handleSearch.bind(this,1)}>搜索</td>
                  </tr>
                  </tbody></table>
              </td></tr>
              <tr><td>
              ...
              <tr><td style={{height:"30px"}}>
                <Button type="primary" style={{width:"100%",position:"fixed",bottom:"0px",borderRadius:"0px"}} onClick={this.handleSearch}>搜索</Button> 
              </td></tr>
            </tbody></table>
        </div>
      </div>  
